...
//			dm.setKey(id);
//			dm.setValue(SimClock.getIntTime());
//			dm.setHost(aMessage.getFrom().name);
//			dm.setTo(aMessage.getTo().name); //Same as the host of create msg
//			from.dm.add(dm);
//			World world=MessageCreateEvent.getWorld();
//			DTNHost to = world.getNodeByAddress(aMessage.getFrom().address);
//			
//			System.out.println("--------------Router-----------------------");
//			System.out.println(aMessage.getFrom().dm);
//			System.out.println(aMessage.getFrom().cm);
//			System.out.println(aMessage.getFrom().name);
//			System.out.println(to.cm);
//			System.out.println(to.dm);
