...
public class ProphetV2Router extends ActiveRouter {
	...
	//	System.out.println("Updating delivary prediction for "+otherHost);
...
//		 Iterator<Map.Entry<DTNHost, Double>> itr = preds.entrySet().iterator();
//		
//		  while(itr.hasNext()) 
//	        { 
//	             Map.Entry<DTNHost, Double> entry = itr.next(); 
//	             DTNHost p=entry.getKey();
//	             System.out.println("Dtn Host ID = " + p.name +  
...
//		
	...
	//	System.out.println("Old value for HOST: "+oldValue);
		double newValue = oldValue + (1 - oldValue) * PEnc;
	//	System.out.println("New value for HOST: "+newValue);
	...
	//	System.out.println("\n\nUpdating Transitive delivary prrediction for "+host);
...
//				System.out.println("\n\nFinal P2---------->"+p2);
//				System.out.println("Final P1---------->"+p1);
//			System.out.println("\nFinal Tuple1->"+tuple1);
//				System.out.println("Final Tuple2->"+tuple2+"\n\n");
				return 1;
			}
		}

		private int compareByQueueMode(Message key, Message key2) {
