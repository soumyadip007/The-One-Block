...
public class MessageCreateEvent extends MessageEvent {
	...
	public void processEvent(World world) {
		...
		this.w=world;
					...
					System.out.println("DTNHost From -> GAS"+from.gas);
					...
					System.out.println("DTNHost To -> GAS "+to.gas+"\n");

					
	
					DTNHost.mr.put(this.id, new MessageRecord(from.address+"",to.address+"",false));
